...
Ctrl.$inject = ['$scope', '$timeout', 'gScope', 'Consulta', 'Clientes'];

function Ctrl($scope, $timeout, gScope, Consulta, Clientes) {
...
(function (window, angular) {
	...
	angular.module('app').factory('Clientes', Clientes);

	Clientes.$inject = ['$ajax', '$q', '$rootScope', '$timeout', 'gScope'];
